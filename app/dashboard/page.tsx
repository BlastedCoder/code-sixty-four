...
export default function DashboardPage() {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center text-slate-500 dark:text-muted font-bold animate-pulse">Loading Dashboard...</div>;
  }
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-background p-6 md:p-12">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <section className="bg-white dark:bg-card rounded-2xl shadow-sm border border-slate-200 dark:border-card-border p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-muted font-medium">{user?.email}</p>
            </div>
          </div>
        ...
        <section>
          ...
          {myLeagues.length === 0 ? (
            <div className="bg-white dark:bg-card border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl p-12 text-center">
              <p className="text-slate-500 dark:text-muted font-medium mb-4">You aren't in any leagues yet!</p>
