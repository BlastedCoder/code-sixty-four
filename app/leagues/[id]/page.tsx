          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-bold transition-all text-sm border ${
              copied 
                ...
                : 'bg-white dark:bg-card border-slate-200 dark:border-card-border text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-background'
            }`}
          >
            ...
            <div className="flex border-b border-slate-200 dark:border-card-border bg-slate-50 dark:bg-background px-2 pt-2 overflow-x-auto hide-scrollbar">
              <button 
                ...
                className={`flex items-center gap-2 px-6 py-4 text-sm font-extrabold border-b-2 transition-all whitespace-nowrap ${
                  activeTab === 'standings' ? 'border-emerald-500 text-emerald-700 bg-white dark:bg-card rounded-t-lg' : 'border-transparent text-slate-500 dark:text-muted hover:text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-t-lg'
                }`}
              >
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-6 py-4 text-sm font-extrabold border-b-2 transition-all whitespace-nowrap ${
                  activeTab === 'bracket' ? 'border-blue-500 text-blue-700 bg-white dark:bg-card rounded-t-lg' : 'border-transparent text-slate-500 dark:text-muted hover:text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-t-lg'
                }`}
              >
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-6 py-4 text-sm font-extrabold border-b-2 transition-all whitespace-nowrap ${
                  activeTab === 'roster' ? 'border-slate-800 text-slate-900 dark:text-white bg-white dark:bg-card rounded-t-lg' : 'border-transparent text-slate-500 dark:text-muted hover:text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-t-lg'
                }`}
              >
